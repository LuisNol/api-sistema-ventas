...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('electronic_notes', function (Blueprint $table) {
            ...
            $table->string('doc_nota', 10)->default('07')->comment('07 credito,08 debito');
            $table->string('type_nota', 5);
            $table->string('n_comprobante', 150);
            ...
            $table->smallInteger('state_entrega')->default(1)->comment('1 es pendiente, 2 es parcial, 3 completo');
            $table->double('amount_anticipo')->default(0);
            $table->json('sales_anticipos')->nullable();
            $table->text('description')->nullable();
            $table->text('description_motivo')->nullable();
            ...
            $table->unique('n_operacion', 'noperacion_electronic_notes');
            $table->unique(['serie', 'correlativo'], 'electronic_notes_serie_correlativo');
        });
    }
